...
import com.michaelstucki.srflashcards.dto.Card;
...
import static com.michaelstucki.srflashcards.constants.Constants.cardToken;
...
public class ControllerCards {
    ...
    /**
     * Custom Cards Controller Constructor
     * @param sceneManager Scene Manager Singleton
     * @param dao Dao Singleton
     */
    public ControllerCards(SceneManager sceneManager, Dao dao) {
    ...
    private void resetListView() {
        ...
        Platform.runLater(() -> cardsView.requestFocus()); // set focus on listView
    }
