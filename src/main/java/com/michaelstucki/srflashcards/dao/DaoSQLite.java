package com.michaelstucki.srflashcards.dao;
...
import static com.michaelstucki.srflashcards.constants.Constants.*;
 ...
 * @since 2025-09-21
 */
public enum DaoSQLite implements Dao {
    /**
    ...
    DaoSQLite() {
        decks = new HashMap<>();
        url = "jdbc:sqlite:" + System.getProperty("user.home") + databaseName + "?foreign_keys=true";
        createTables();
    }
